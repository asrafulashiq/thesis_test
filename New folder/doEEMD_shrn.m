function [HRe,peaks]=doEEMD_shrn(sig4emd,HR0,del_cnt,Fs,wname)
NE=8;
SNR=30;
imfs1={};
imfs2={};
...
for a=1:2
    ...
    pks1=maxFind_shrn(sig4maxFind,Fs);
    S_imf(a)=pks1;
    pks2=sig2HR_wavelet_shrn(sig4maxFind,Fs,wname); %/change/
    S_imf(a+2)=pks2;
end
